...
class HttpDownloadRequestTests: XCTestCase {
    ...
    func testFullConstructor() {
        ...
        let request = HttpDownloadRequest(url: url, destinationUrl: destination)
    ...
    func testHashValue() {
        ...
        let request1 = HttpDownloadRequest(url: url, destinationUrl: destination1)
        let request2 = HttpDownloadRequest(url: url, destinationUrl: destination2)
